...
> The variable fc had the largest relative error. This coluld be because carbon flux changes a lot over different time periods. Variables with high variability and a small sample may might not show all of the possibel values. More samples might be needed to see the full range of values.
---
